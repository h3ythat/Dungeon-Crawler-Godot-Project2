...
/** @type {string} */
const CACHE_VERSION = '1762209510|81954211';
/** @type {string} */
const CACHE_PREFIX = 'dungeon crawler -sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dungeon crawler godot project.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dungeon crawler godot project.html","dungeon crawler godot project.js","dungeon crawler godot project.offline.html","dungeon crawler godot project.icon.png","dungeon crawler godot project.apple-touch-icon.png","dungeon crawler godot project.audio.worklet.js","dungeon crawler godot project.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["dungeon crawler godot project.wasm","dungeon crawler godot project.pck","dungeon crawler godot project.side.wasm"];
